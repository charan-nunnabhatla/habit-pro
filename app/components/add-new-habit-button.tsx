...
export default function AddNewHabitButton() {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      title="Add New Habit"
      className=" fixed bottom-0 right-0 m-4 flex items-center justify-center text-center transition-all duration-150 bg-red-800 border-none rounded-full cursor-pointer group hover:bg-red-600 size-12 ">
